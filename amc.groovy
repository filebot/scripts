...
def kodi = tryQuietly{ any{kodi}{xbmc}.split(/[ ,|]+/).collect{instance->(instance =~ /((?:[a-z0-9]+:[a-z0-9]+@)?(?:[.a-z0-9]+)):?([0-9]+)?$/).collect{it[2] != null ? [host: it[1], port: it[2] as int] : [host: it[1], port: 8080]}}}
