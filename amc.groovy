...
def reportFile = getReportMessage().saveAs(new File(reportFolder, "AMC ${new Date().format('''- yyyy-MM-dd - hh'h'mm'm'ss's' -''')} ${getReportSubject().take(100)}.html".validateFileName()))
