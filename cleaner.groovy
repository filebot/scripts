...
def isClutter(f) {
	...
	// black list
	def exts    = tryQuietly{ exts }            ?: /jpg|jpeg|png|gif|ico|nfo|info|xml|htm|html|log|srt|sub|idx|md5|sfv|txt|rtf|url|db|dna|log|tgmd|json|data|srv|srr|nzb|par\d+|part\d+/
